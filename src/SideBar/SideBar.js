  ...
  return (
    <StyledDrawer variant={"permanent"} anchor="left">
      ...
      <StyledList sx={{ paddingTop: "80px" }}>
        <ListItem button onClick={() => handleButtonClick("all")}>
          <StyledListItemIcon sx={{ color: "blue" }}>
            <ViewModuleIcon />
          </StyledListItemIcon>
          <StyledListItemText primary="Show All" />
        </ListItem>
        <ListItem button onClick={() => handleButtonClick("unpaidGarbageTax")}>
          <StyledListItemIcon sx={{ color: "blue" }}>
            <DeleteIcon />
          </StyledListItemIcon>
          <StyledListItemText primary="Garbage Tax" />
        </ListItem>
        <ListItem button onClick={() => handleButtonClick("unpaidPropertyTax")}>
          <StyledListItemIcon sx={{ color: "blue" }}>
            <HomeIcon />
          </StyledListItemIcon>
          <StyledListItemText primary="Property Tax" />
        </ListItem>
        <ListItem button onClick={() => handleButtonClick("unpaidWaterTax")}>
          <StyledListItemIcon sx={{ color: "blue" }}>
            <LocalDrinkIcon />
          </StyledListItemIcon>
